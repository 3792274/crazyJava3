package chapter12_12_使用JFormattedTextField和JtextPane;
...
public class MyTextPane extends JTextPane
{
	...
	protected SyntaxFormatter formatter = new SyntaxFormatter("第12章Swing编程\\chapter12_12_使用JFormattedTextField和JtextPane\\my.stx");
	// 定义该文档的普通文本的外观属性
